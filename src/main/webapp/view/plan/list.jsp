                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <s:iterator value='#session.arraylist' var="v">
                                <tr>
                                    ...
                                    <td><s:property value='#v.loadnum'/></td>
                                    <td><s:date name='#v.start_time' format="yyyy/MM/DD"/></td>
                                    <td><s:date name='#v.end_time' format="yyyy/MM/DD"/></td>
                                    <td><s:property value='#v.user.id'/></td>
                                    <s:if test="#v.active==true">
                                        <td class="center">
                                    ...
                                    <td><s:property value='#v.mediaResource.resource_name'/></td>
                                    <td class="center">
                                        <a class="btn btn-success" href="<%=request.getContextPath()%>/view/profile.jsp?id=<s:property value='#v.id'/>">
